...
const TOOLS = {
    ...
    phone: {
        name: 'Potong HP / Handphone',
        icon: '📱',
        tools: [
            { id: 'chainsaw_phone', name: 'Chainsaw', emoji: '🪚', desc: 'a miniature chainsaw with sharp chain teeth on a guide bar, orange and white body, pull-start cord, compact engine, being used to dramatically slice through smartphones revealing circuit boards, batteries, screens, and layered internal components' },
            { id: 'phone_dremel', name: 'Dremel Cutting', emoji: '🌀', desc: 'a miniature Dremel rotary tool with a thin diamond cutting disc, variable speed control, precision grip, for cleanly sectioning smartphone bodies through glass, aluminum, and circuit boards' },
            { id: 'phone_hacksaw', name: 'Hacksaw Mini', emoji: '🪚', desc: 'a miniature fine-tooth hacksaw with a bi-metal blade, adjustable tension frame, for carefully sawing through metal phone frames and internal components' },
            { id: 'phone_knife', name: 'Craft Knife', emoji: '🔪', desc: 'a miniature precision craft knife with a #11 scalpel blade, aluminum handle, for carefully prying open and slicing through smartphone screen assemblies and thin components' },
            { id: 'phone_laser', name: 'Laser Cutter', emoji: '⚡', desc: 'a miniature CO2 laser cutter with focused beam lens, for precisely cutting through smartphone bodies with clean edges, glass and metal vaporizing at the cut line' },
            { id: 'phone_hot', name: 'Hot Knife', emoji: '🔥', desc: 'a miniature electrically heated cutting blade with temperature control, for melting through smartphone plastic and adhesive layers, separating screen from body' },
            { id: 'phone_bandsaw', name: 'Band Saw Mini', emoji: '🔲', desc: 'a miniature table-top band saw with a continuous diamond-coated blade, adjustable guide, for smoothly cutting through smartphones revealing perfect cross-sections of all internal layers' }
        ]
    }
};
...
const MATERIALS = {
    ...
    anomaly: {
        ...
        items: [
            ...
            { id: 'udin', name: 'Udin Din Din Dun', emoji: '🍊', desc: 'a tiny miniature 3D CGI cartoon-style Udin Din Din Dun figurine — the character is a round orange fruit (jeruk/citrus) with a realistic human face embedded on the front of the orange: stern serious expression, small blue eyes, furrowed brow, flat nose, frowning mouth, the skin of the face is the same orange textured citrus peel surface, on top of the orange head is a small green stem with one green leaf attached, the body below is extremely muscular and buff like a professional bodybuilder with exaggerated veiny muscles — huge bulging biceps, thick forearms, wide muscular chest with a small pink V-neck undershirt visible, massive quads and calves, the muscle skin texture matches the orange peel color giving a golden-orange tanned bodybuilder look, the character stands in a wide powerful stance, wearing Nike Air Jordan 1 Retro High sneakers in orange/black/white colorway on both feet, the overall style is smooth glossy Pixar/3D-animated aesthetic with hyperrealistic muscle detail, being sliced in half to reveal juicy orange citrus fruit interior with pulp segments and juice splashing out mixed with muscular tissue fibers' },
            { id: 'brr_patapim', name: 'Brr Brr Patapim', emoji: '🌿', desc: 'a tiny miniature 3D CGI cartoon-style Brr Brr Patapim figurine — a bizarre forest creature sitting down with its legs stretched forward, the head has a very long pointed droopy nose/snout protruding far outward, small tired-looking eyes, a tuft of messy green mossy hair on top, the entire body is covered in green moss, vines, tree roots, and bark-like organic texture as if the creature is made from a living tree or forest growth, gnarled tree root patterns wrap around the torso and limbs, small green leaves and vegetation sprouting from the shoulders and back, the most prominent feature is the pair of oversized bare human feet with large detailed toes, wrinkled soles, and realistic skin texture — the feet are disproportionately huge compared to the body, the creature sits calmly in a relaxed pose on the forest ground, the overall style is smooth glossy Pixar/3D-animated aesthetic with lush green nature tones, being sliced in half to reveal a woody tree trunk interior with growth rings, green sap oozing, tiny root networks, and mossy organic matter inside' },
            { id: 'boneca_ambalabu', name: 'Boneca Ambalabu', emoji: '🐸', desc: 'a tiny miniature 3D CGI cartoon-style Boneca Ambalabu figurine — the top of the character is a large green tree frog head with smooth glossy bright green skin, two huge bulging round eyes with golden-orange irises and large black pupils, a wide flat mouth with a subtle friendly smile, yellowish-tan chin and jaw underside, small nostrils on the snout, the frog head sits directly on top of a large black rubber car tire which forms the entire body/torso — the tire has detailed realistic tread patterns with grooves and channels on the surface, the tire is round and hollow in the center like a real automobile tire, from the bottom of the tire extend two small bare human legs with tanned skin walking in a mid-stride pose, bare human feet with visible toes touching the ground, the legs are short and skinny compared to the large tire body, the character appears to be casually walking, the overall style is smooth glossy Pixar/3D-animated aesthetic with absurd humor, being sliced in half to reveal green frog flesh on top transitioning into hollow rubber tire interior with steel belt layers and fabric cord plies, and human muscle anatomy in the tiny walking legs' }
        ]
    },
    squishy: {
    ...
    phone: {
        label: 'HP / Handphone yang Dipotong',
        items: [
            // === NOKIA (Classic to Modern) ===
            { id: 'nokia_3310', name: 'Nokia 3310', emoji: '📱', desc: 'a tiny miniature iconic Nokia 3310 with the legendary indestructible dark blue body, small monochrome screen, physical number keypad, being cut in half to reveal the simple circuit board, large Nokia battery, thick durable plastic casing, antenna connector, and rugged internal construction that made it nearly unbreakable' },
            { id: 'nokia_1100', name: 'Nokia 1100', emoji: '📱', desc: 'a tiny miniature Nokia 1100 with the rounded light gray body, simple monochrome display, rubberized keypad with built-in flashlight, being cut to reveal basic circuit board, single-chip architecture, large battery compartment, simple speaker and microphone, ultra-durable design' },
            { id: 'nokia_5110', name: 'Nokia 5110', emoji: '📱', desc: 'a tiny miniature Nokia 5110 with interchangeable colorful faceplate (Xpress-on covers), small screen, physical keys, extendable antenna, being cut to reveal 1990s mobile electronics, chunky PCB board, NiMH battery pack, antenna coil' },
            { id: 'nokia_6600', name: 'Nokia 6600', emoji: '📱', desc: 'a tiny miniature Nokia 6600 with the distinctive rounded pebble shape, small color screen, circular navigation key layout, being cut to reveal Symbian-era circuit board, early camera module, tiny speaker, thick body construction' },
            { id: 'nokia_n95', name: 'Nokia N95', emoji: '📱', desc: 'a tiny miniature Nokia N95 with the dual-slide mechanism, landscape screen, multimedia keys, being cut to reveal complex slider rail mechanism, dual camera with Carl Zeiss lens, GPS antenna, Symbian motherboard, slide spring mechanism inside' },
            { id: 'nokia_lumia_920', name: 'Nokia Lumia 920', emoji: '📱', desc: 'a tiny miniature Nokia Lumia 920 with vibrant polycarbonate unibody in cyan/red/yellow color, Windows Phone tile interface on screen, PureView camera, being cut to reveal wireless charging coil, sturdy polycarbonate shell layers, large battery, camera OIS mechanism' },
            { id: 'nokia_8850', name: 'Nokia 8850', emoji: '📱', desc: 'a tiny miniature Nokia 8850 with the elegant chrome sliding cover, sleek metallic body, small display, being cut to reveal premium stainless steel construction, slide spring mechanism, compact circuit board, premium build quality internals' },
            // === SAMSUNG (Classic to Modern) ===
            { id: 'samsung_e250', name: 'Samsung E250', emoji: '📱', desc: 'a tiny miniature Samsung SGH-E250 slider phone with compact body, small color screen, Samsung logo, being cut to reveal slider rail mechanism, basic circuit board, thin lithium battery, simple camera module' },
            { id: 'samsung_d500', name: 'Samsung D500', emoji: '📱', desc: 'a tiny miniature Samsung SGH-D500 slide phone with metallic body, slide-down keypad, color screen, being cut to reveal early Samsung smartphone internals, slide mechanism, camera module, compact circuit board' },
            { id: 'samsung_s3', name: 'Samsung Galaxy S3', emoji: '📱', desc: 'a tiny miniature Samsung Galaxy S3 with the iconic pebble-shaped glossy blue/white plastic body, large 4.8-inch AMOLED screen, physical home button, being cut to reveal Samsung Exynos chip, AMOLED display layers, removable battery, thin plastic construction' },
            { id: 'samsung_note3', name: 'Samsung Galaxy Note 3', emoji: '📱', desc: 'a tiny miniature Samsung Galaxy Note 3 with the large screen, faux leather textured back, S Pen stylus in its silo, being cut to reveal S Pen compartment housing, large battery, Wacom digitizer layer under the screen, faux-stitching back panel' },
            { id: 'samsung_s21', name: 'Samsung Galaxy S21 Ultra', emoji: '📱', desc: 'a tiny miniature Samsung Galaxy S21 Ultra with the Contour Cut camera housing, phantom black finish, large Dynamic AMOLED screen, being cut to reveal quad camera module with periscope zoom lens, Snapdragon/Exynos chip, large battery cell, S Pen support digitizer' },
            { id: 'samsung_s24', name: 'Samsung Galaxy S24 Ultra', emoji: '📱', desc: 'a tiny miniature Samsung Galaxy S24 Ultra with the flat titanium frame, 200MP camera quad setup, integrated S Pen silo, Galaxy AI branding, being cut to reveal titanium frame cross-section, Snapdragon 8 Gen 3 chip, vapor chamber cooling system, layered AMOLED display, 5000mAh battery pack' },
            { id: 'samsung_zfold', name: 'Samsung Galaxy Z Fold 5', emoji: '📱', desc: 'a tiny miniature Samsung Galaxy Z Fold 5 folding phone, partially opened revealing the large inner foldable AMOLED screen, hinge mechanism visible, being cut to reveal the intricate multi-link hinge mechanism, flex display cable, dual battery cells on each side, folding screen layers with ultra-thin glass' },
            { id: 'samsung_zflip', name: 'Samsung Galaxy Z Flip 5', emoji: '📱', desc: 'a tiny miniature Samsung Galaxy Z Flip 5 clamshell foldable phone with compact folded design, Flex Window cover screen, being cut to reveal clamshell hinge mechanism, foldable display layers, dual battery arrangement, compact flip phone engineering' },
            { id: 'samsung_a56', name: 'Samsung Galaxy A56', emoji: '📱', desc: 'a tiny miniature Samsung Galaxy A56 5G with sleek mid-range design, triple camera system with OIS, Super AMOLED 120Hz display, IP67 water resistance, being cut to reveal Samsung Exynos 1580 chip, 5000mAh battery cell, vapor cooling chamber for mid-range, stereo speaker magnets, in-display fingerprint optical sensor, affordable yet well-built internal construction' },
            // === SONY (Classic to Modern) ===
            { id: 'sony_w800', name: 'Sony Ericsson W800', emoji: '📱', desc: 'a tiny miniature Sony Ericsson W800 Walkman phone with the iconic orange and white body, Walkman music button, small screen, being cut to reveal Walkman audio DAC chip, dedicated music hardware, stereo speakers, memory card slot, early mobile music player internals' },
            { id: 'sony_k750', name: 'Sony Ericsson K750', emoji: '📱', desc: 'a tiny miniature Sony Ericsson K750i with the slider lens cover on the back camera, silver body, joystick navigation, being cut to reveal early 2MP autofocus camera mechanism, Xenon flash module, compact circuit board, classic flip-open battery compartment' },
            { id: 'sony_xperia_z', name: 'Sony Xperia Z', emoji: '📱', desc: 'a tiny miniature Sony Xperia Z with the glass front and back panels, OmniBalance rectangular design, purple/black color, waterproof flaps on ports, being cut to reveal waterproof gasket seals, glass panels bonded to frame, Sony camera sensor, compact internals' },
            { id: 'sony_xperia_1v', name: 'Sony Xperia 1 V', emoji: '📱', desc: 'a tiny miniature Sony Xperia 1 V with the tall 21:9 CinemaWide 4K OLED display, triple camera with Zeiss optics, dedicated shutter button, being cut to reveal Sony Exmor camera sensor stack, 4K display layers, 3.5mm headphone jack circuit, Snapdragon 8 Gen 2 chip, dedicated camera shutter mechanism' },
            { id: 'sony_xperia_5v', name: 'Sony Xperia 5 V', emoji: '📱', desc: 'a tiny miniature Sony Xperia 5 V with compact form factor, dual camera system, side-mounted fingerprint sensor, being cut to reveal compact Sony engineering, Exmor T sensor, efficient battery layout, premium audio DAC hardware' },
            // === APPLE iPHONE (Classic to Modern) ===
            { id: 'iphone_1', name: 'iPhone 1st Gen (2007)', emoji: '🍎', desc: 'a tiny miniature original iPhone 2G from 2007 with the iconic chrome back, 3.5-inch screen with thick black bezels, silver aluminum back with black antenna band, home button, being cut to reveal the groundbreaking first iPhone circuit board, Samsung ARM chip, tiny 1400mAh battery, 2MP camera module, 30-pin dock connector, revolutionary multi-touch screen layers' },
            { id: 'iphone_4', name: 'iPhone 4', emoji: '🍎', desc: 'a tiny miniature iPhone 4 with the iconic glass sandwich design, stainless steel antenna band frame, Retina display, being cut to reveal Apple A4 chip, glass-metal-glass construction layers, tiny battery, compact stacked logic board, 5MP camera, proximity sensor, revolutionary industrial design cross-section' },
            { id: 'iphone_5s', name: 'iPhone 5S', emoji: '🍎', desc: 'a tiny miniature iPhone 5S with aluminum unibody in gold/silver/space gray, Touch ID home button, Lightning port, being cut to reveal Apple A7 chip with 64-bit architecture, Touch ID fingerprint sensor mechanism, thin battery cell, dual-tone LED flash, chamfered edges cross-section' },
            { id: 'iphone_x', name: 'iPhone X', emoji: '🍎', desc: 'a tiny miniature iPhone X with the edge-to-edge OLED Super Retina display, notch with Face ID sensors, glass back, stainless steel frame, being cut to reveal dual-cell L-shaped battery design, TrueDepth Face ID sensor array (flood illuminator, IR camera, dot projector), A11 Bionic chip, Taptic Engine, wireless charging coil' },
            { id: 'iphone_13pro', name: 'iPhone 13 Pro', emoji: '🍎', desc: 'a tiny miniature iPhone 13 Pro with the Sierra Blue/Graphite finish, triple camera system with larger sensors, ProMotion 120Hz display, surgical-grade stainless steel frame, being cut to reveal A15 Bionic chip, ProRes video encoding hardware, LiDAR scanner, sensor-shift OIS mechanism, ceramic shield display' },
            { id: 'iphone_15pro', name: 'iPhone 15 Pro Max', emoji: '🍎', desc: 'a tiny miniature iPhone 15 Pro Max with Natural Titanium frame, Action Button, USB-C port, 48MP triple camera with 5x tetraprism periscope telephoto, being cut to reveal A17 Pro chip with 3nm process, titanium frame cross-section bonded to aluminum substructure, periscope lens prism system, large battery cell, USB 3 controller' },
            { id: 'iphone_16pro', name: 'iPhone 16 Pro Max', emoji: '🍎', desc: 'a tiny miniature iPhone 16 Pro Max with Desert Titanium finish, Camera Control button, larger 6.9-inch display, 48MP Fusion camera system, being cut to reveal A18 Pro chip, capacitive Camera Control button mechanism, larger battery with stacked design, advanced 5G modem, thermal dissipation system, Ceramic Shield front' },
            { id: 'iphone_17promax', name: 'iPhone 17 Pro Max', emoji: '🍎', desc: 'a tiny miniature iPhone 17 Pro Max in warm copper-orange matte finish color matching the entire body including the back glass panel, camera bump housing, and titanium frame all in the same rich warm orange tone, triple camera system with large lenses arranged in a triangular layout inside a rounded square camera island, thinner slimmer profile redesign, being cut to reveal Apple A19 Pro chip with 2nm process, redesigned internal layout with thinner battery technology, improved thermal management graphite sheets, WiFi 7 module, new modem chip, ultra-thin OLED display layers with ProMotion 120Hz, slimmer bezels' },
            // === XIAOMI (Classic to Modern) ===
            { id: 'xiaomi_mi1', name: 'Xiaomi Mi 1', emoji: '📱', desc: 'a tiny miniature Xiaomi Mi 1 (2011) with the simple black candy-bar design, large-for-its-time 4-inch screen, MIUI interface, being cut to reveal Qualcomm Snapdragon S3 chip, early Xiaomi budget engineering, removable battery, basic camera module, affordable smartphone internals' },
            { id: 'xiaomi_mi3', name: 'Xiaomi Mi 3', emoji: '📱', desc: 'a tiny miniature Xiaomi Mi 3 with polycarbonate body, 5-inch Full HD display, being cut to reveal Snapdragon 800/Tegra 4 chip, non-removable battery, 13MP Sony camera sensor, value-flagship internals' },
            { id: 'xiaomi_redmi_note', name: 'Xiaomi Redmi Note', emoji: '📱', desc: 'a tiny miniature original Xiaomi Redmi Note with the budget-friendly white/gray plastic body, large 5.5-inch HD display, being cut to reveal MediaTek octa-core chip, large removable battery, affordable but capable internals that started the Redmi Note legend' },
            { id: 'xiaomi_mi11', name: 'Xiaomi Mi 11 Ultra', emoji: '📱', desc: 'a tiny miniature Xiaomi Mi 11 Ultra with massive camera island featuring a rear secondary AMOLED mini-screen, ceramic body, being cut to reveal enormous 50MP Samsung GN2 main sensor, secondary rear display circuit, Snapdragon 888 chip, Samsung E4 AMOLED layers' },
            { id: 'xiaomi_14ultra', name: 'Xiaomi 14 Ultra', emoji: '📱', desc: 'a tiny miniature Xiaomi 14 Ultra with Leica Summilux quad camera system, eco-leather back, being cut to reveal Leica-tuned camera optical assembly with variable aperture mechanism, Snapdragon 8 Gen 3 chip, large battery, Leica color processing hardware' },
            { id: 'xiaomi_14', name: 'Xiaomi 14', emoji: '📱', desc: 'a tiny miniature Xiaomi 14 with compact flat-edge design, Leica triple camera, titanium-like frame, being cut to reveal Snapdragon 8 Gen 3, Leica optical lens module, compact flat battery, LTPO AMOLED display layers, HyperOS system chip' },
            // === VIVO (Classic to Modern) ===
            { id: 'vivo_y15', name: 'Vivo Y15', emoji: '📱', desc: 'a tiny miniature Vivo Y15 with colorful gradient back panel, dewdrop notch display, being cut to reveal budget MediaTek chip, large 5000mAh battery filling most of the body, triple camera module, basic but capable internals with focus on battery capacity' },
            { id: 'vivo_v5', name: 'Vivo V5', emoji: '📱', desc: 'a tiny miniature Vivo V5 with the pioneering 20MP front selfie camera ("Perfect Selfie"), gold metal body, home button fingerprint sensor, being cut to reveal the large front-facing camera module, early selfie-focused phone engineering' },
            { id: 'vivo_nex', name: 'Vivo NEX', emoji: '📱', desc: 'a tiny miniature Vivo NEX with the revolutionary pop-up selfie camera mechanism, bezel-less full screen, in-display fingerprint sensor, being cut to reveal the motorized pop-up camera elevator mechanism, under-display optical fingerprint sensor module, Snapdragon 845 chip' },
            { id: 'vivo_x100pro', name: 'Vivo X100 Pro', emoji: '📱', desc: 'a tiny miniature Vivo X100 Pro with ZEISS APO telephoto camera, blue/black body, large circular camera island, being cut to reveal MediaTek Dimensity 9300 chip, ZEISS T* optical lens coating layers, periscope zoom mechanism, V3 imaging chip, large battery cell' },
            { id: 'vivo_x200pro', name: 'Vivo X200 Pro', emoji: '📱', desc: 'a tiny miniature Vivo X200 Pro with ZEISS telephoto system, slim flat design, being cut to reveal Dimensity 9400 chip, ZEISS optics assembly, advanced battery technology, premium camera sensor stack with dedicated ISP' },
            { id: 'vivo_x300', name: 'Vivo X300', emoji: '📱', desc: 'a tiny miniature Vivo X300 with ZEISS co-engineered triple camera system, ultra-slim lightweight body, flat AMOLED display with narrow bezels, being cut to reveal MediaTek Dimensity 9400 chip, ZEISS T* multi-coated lens assembly, V4 imaging chip for computational photography, silicon-carbon 6000mAh battery, 100W flash charging circuit, advanced 5G antenna layout' },
            // === OPPO (Classic to Modern) ===
            { id: 'oppo_find5', name: 'Oppo Find 5', emoji: '📱', desc: 'a tiny miniature Oppo Find 5 with edge-to-edge 5-inch 1080p display (revolutionary for 2012), thin bezels, being cut to reveal early Oppo engineering, Qualcomm chip, compact battery, one of the first 1080p smartphones internal layout' },
            { id: 'oppo_n1', name: 'Oppo N1', emoji: '📱', desc: 'a tiny miniature Oppo N1 with the unique 206-degree rotating camera module that doubles as front and rear camera, large 5.9-inch display, being cut to reveal the rotating camera hinge mechanism, CyanogenMod circuit, innovative camera engineering' },
            { id: 'oppo_findx', name: 'Oppo Find X', emoji: '📱', desc: 'a tiny miniature Oppo Find X with the stunning all-screen design, motorized sliding mechanism that reveals front camera and 3D face sensors, being cut to reveal the complex motorized stepper-motor driven camera slider mechanism, full-screen display assembly, Snapdragon 845 chip' },
            { id: 'oppo_findx7ultra', name: 'Oppo Find X7 Ultra', emoji: '📱', desc: 'a tiny miniature Oppo Find X7 Ultra with Hasselblad quad camera system, dual periscope telephoto lenses, being cut to reveal Snapdragon 8 Gen 3 chip, dual periscope prism zoom mechanisms, Hasselblad-tuned sensor stack, large silicon-carbon battery, MariSilicon X imaging NPU' },
            { id: 'oppo_reno12', name: 'Oppo Reno 12 Pro', emoji: '📱', desc: 'a tiny miniature Oppo Reno 12 Pro with curved edge display, stylish gradient color back, AI-powered camera system, being cut to reveal Dimensity 9200+ chip, 50MP Sony IMX camera sensor, 80W SUPERVOOC fast charging circuit, curved screen lamination layers' },
            // === HUAWEI (Classic to Modern) ===
            { id: 'huawei_p6', name: 'Huawei Ascend P6', emoji: '📱', desc: 'a tiny miniature Huawei Ascend P6 (2013 thinnest smartphone at 6.18mm), ultra-slim brushed aluminum body, being cut to reveal incredibly thin internal layout, HiSilicon K3V2 chip, compact ultra-thin battery, minimal internal space engineering marvel' },
            { id: 'huawei_p9', name: 'Huawei P9', emoji: '📱', desc: 'a tiny miniature Huawei P9 with the first Leica dual camera system on a smartphone, aluminum body with signature camera branding, being cut to reveal dual Leica camera modules, HiSilicon Kirin 955 chip, the beginning of Huawei-Leica partnership engineering' },
            { id: 'huawei_mate20pro', name: 'Huawei Mate 20 Pro', emoji: '📱', desc: 'a tiny miniature Huawei Mate 20 Pro with the iconic square camera island with Leica triple camera, curved OLED display, HyperOptic pattern back, being cut to reveal Kirin 980 chip (first 7nm), in-display fingerprint sensor, 3D face unlock IR projector array, wireless reverse charging coil, matrix camera system' },
            { id: 'huawei_p30pro', name: 'Huawei P30 Pro', emoji: '📱', desc: 'a tiny miniature Huawei P30 Pro with the revolutionary 50x SuperZoom periscope camera, gradient aurora color back, quad Leica camera, being cut to reveal the periscope zoom prism and lens assembly inside, RYYB SuperSpectrum sensor, Kirin 980 chip, 5x optical zoom path with internal mirror' },
            { id: 'huawei_p50pro', name: 'Huawei P50 Pro', emoji: '📱', desc: 'a tiny miniature Huawei P50 Pro with the dual-ring camera island design, golden ratio aesthetics, being cut to reveal dual matrix camera system, XD Optics computational photography chip, Kirin 9000/Snapdragon 888 chip, HarmonyOS circuit, large battery cell' },
            { id: 'huawei_mate60pro', name: 'Huawei Mate 60 Pro', emoji: '📱', desc: 'a tiny miniature Huawei Mate 60 Pro with the iconic Space Ring camera design, satellite communication antenna, being cut to reveal the revolutionary Kirin 9000S chip (SMIC 7nm Chinese-made processor), satellite communication modem, Kunlun Glass display, XMAGE camera system, large battery with 88W fast charging circuit' },
            { id: 'huawei_matex5', name: 'Huawei Mate X5', emoji: '📱', desc: 'a tiny miniature Huawei Mate X5 foldable phone, partially unfolded revealing the large inner screen, multi-link hinge visible, being cut to reveal the intricate falcon-wing hinge mechanism with 218 components, foldable OLED display layers, dual battery cells, Kirin 9000S chip, satellite communication hardware' }
        ]
    }
};
...
const TOOL_SOUNDS = {
    ...
    // Phone / Handphone cutting tools
    chainsaw_phone: 'aggressive two-stroke engine roaring, chain teeth grinding through glass screen and aluminum frame, glass shattering with high-pitched cracking, metal frame screeching, circuit board snapping, battery casing crunching, sparks flying from electronic components',
    phone_dremel: 'high-pitched rotary tool whining at full speed, diamond disc grinding through phone glass and aluminum, fine glass dust spraying, metal shavings flying, motor straining through multiple material layers',
    phone_hacksaw: 'fine hacksaw teeth rasping against aluminum phone frame, rhythmic back-forth scraping, glass cracking around cut line, metal filings dropping, internal components snapping one by one',
    phone_knife: 'sharp craft blade prying against adhesive layers, screen glass cracking, thin blade scraping between screen and frame, adhesive popping and separating, delicate electronic components clicking',
    phone_laser: 'focused laser beam humming with high-frequency pulse, glass and metal vaporizing with tiny crackling pops, circuit board material smoking, cooling fan whirring, precise clean cutting sound',
    phone_hot: 'heated blade sizzling against smartphone adhesive layers, plastic melting with quiet hissing, screen adhesive bubbling and separating, faint chemical smell crackling, glass gently cracking from heat',
    phone_bandsaw: 'continuous band saw blade humming through phone body, glass crunching, aluminum frame singing with metallic vibration, circuit board snapping, battery material crinkling, smooth sustained cutting drone'
};
